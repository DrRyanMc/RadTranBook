...
def run_method(dt, use_nonlinear, max_newton_iter, newton_tol, t_final=0.1, n_cells=400):
    """
    ...
    # Time evolution - use solver's built-in time stepping
    n_steps = int(t_final / dt)
    
    # Track linear solves by monitoring solver stats
    initial_linear_solves = getattr(solver, 'total_linear_solves', 0)
    ...
    if max_newton_iter == 1:
        ...
        avg_newton_iters = 3 if use_nonlinear else 2  # Typical convergence
