...
try:
    from MG_IMC.fleck_cummings.src.MG_IMC2D import (
        init_simulation,
        step,
        __c,
        __a,
...
print("\nTesting mg_utils...")
try:
    from MG_IMC.fleck_cummings.src.mg_utils import (
...
print("Try running: python -m MG_IMC.fleck_cummings.tests.test_2group_marshak")
