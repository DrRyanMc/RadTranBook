...
def run(args):
    ...
    mode_params = {
        ...
        "publication": dict(Ntarget=10_000_000, Nmax_init=20_000_000, Nmax_growth=2_000_000, Nmax_final=220_000_000),
    }
    ...
    if args.resume and os.path.exists(ckpt_path):
        ...
        state = init_simulation(Ntarget, Tinit, Tr_init, mesh, energy_edges,
                                eos, inv_eos, T_emit_floor=0.9*T_INIT)
    ...
    while state.time < T_FINAL - time_tol:
        ...
        state, info = step(
            ...
            T_emit_floor=.9*T_INIT,          # suppress emission below initial temperature
